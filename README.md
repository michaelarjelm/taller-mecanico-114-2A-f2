...
| :---: | :---: | :--- | :--- | :--- |
| 1 | 2026-09-02 | Inicialización de repositorio y bitácora | michaelarjelm | ✅ Completado |
| 2 | 2026-09-07 | Creación de clase base `Vehiculo` en `vehiculo.py`, definición del constructor `__init__` con atributos (`patente`, `anio`, `_en_taller`), y métodos `ingresar()` y `entregar()`. | michaelarjelm | ✅ Completado |
